...
function TransporteMobileImagePatch() {
  // Ctrl+F: TRANSPORTE_MOBILE_IMAGE_PATCH
        ...
        products: [
          {
            ...
            descriptionPlaceholder: {
  es: "Malla de fruta de algodón 100% natural, biodegradable y certificada, desarrollada para marcas y retailers que buscan soluciones de packaging alineadas con altos estándares ambientales y regulatorios.\n\nDiseñada para operar en procesos reales de packing y comercialización, ofrece una combinación sólida de resistencia, uniformidad dimensional y comportamiento consistente en línea, reduciendo roturas y variaciones que afectan la continuidad operacional.\n\nSu fabricación a partir de fibras naturales certificadas permite una integración coherente con estrategias de sustentabilidad y economía circular, entregando una alternativa orgánica para categorías donde la percepción de marca, la trazabilidad y el cumplimiento ambiental son críticos.\n\nProducto noble, con baja huella de carbono y una cadena productiva corta, controlada y trazable, que facilita auditorías, control de calidad por lote y una operación más ordenada.\n\nDisponible en distintas tallas y especificaciones según requerimiento del cliente, para ajustarse al calibre de fruta, tipo de empaque, velocidad de línea y estándar comercial de destino, combinando sustentabilidad real con desempeño confiable en terreno.",
  en: "100% natural, biodegradable, and certified cotton fruit netting, developed for brands and retailers seeking packaging solutions aligned with high environmental and regulatory standards.\n\nEngineered for real packing and commercialization workflows, it delivers a reliable balance of strength, dimensional uniformity, and consistent on-line performance—helping reduce breaks and variability that impact operational continuity.\n\nManufactured from certified natural fibers, it supports sustainability and circular-economy strategies with an organic alternative for categories where brand perception, traceability, and environmental compliance are critical.\n\nA premium product with a low carbon footprint and a short, controlled, and traceable supply chain—facilitating audits, lot-level quality control, and cleaner operations.\n\nAvailable in multiple sizes and specifications according to customer requirements, to match fruit caliber, packaging format, line speed, and destination market standards—combining genuine sustainability with dependable field performance.",
}
,
  ...
  es: "Fabricamos malla de fruta de polietileno (PE) orientada a procesos intensivos de packing y comercialización, especialmente diseñada para operaciones que abastecen a grandes retailers, donde la continuidad operacional, la disponibilidad del insumo y la estandarización del empaque son críticas.\n\nEsta alternativa prioriza alta resistencia mecánica, estabilidad dimensional y un comportamiento consistente turno a turno, permitiendo operar a altas velocidades de línea con menor tasa de roturas, menos detenciones no programadas y una reducción efectiva de la variabilidad operativa.\n\nSu desempeño confiable facilita el cumplimiento de especificaciones comerciales exigidas por retailers, asegurando uniformidad visual del empaque, control del peso por unidad y una presentación consistente en góndola.\n\nEs la opción adecuada para operaciones de alto volumen, ventanas comerciales ajustadas o programas de suministro continuo, donde se requiere respuesta rápida ante picos de demanda y abastecimiento asegurado durante toda la temporada, minimizando riesgos operativos y comerciales.\n\nUna solución funcional, robusta y orientada a resultado, pensada para líneas de packing que no pueden detenerse y para clientes que necesitan cumplir compromisos de entrega con precisión.",
  en: "We manufacture polyethylene (PE) fruit netting engineered for high-throughput packing and commercialization processes, specifically designed for operations supplying major retailers, where operational continuity, input availability, and packaging standardization are critical.\n\nThis option prioritizes high mechanical strength, dimensional stability, and consistent behavior shift after shift—enabling high line speeds with fewer breaks, reduced unplanned stoppages, and lower operational variability.\n\nIts reliable performance supports compliance with retailer packaging specifications, ensuring visual uniformity, controlled unit weight, and consistent shelf presentation.\n\nIt is the right solution for high-volume operations, tight commercial windows, or continuous supply programs where rapid response to demand peaks and guaranteed seasonal availability are required—minimizing both operational and commercial risk.\n\nA functional, robust, results-oriented solution built for packing lines that cannot stop and for customers who must meet delivery commitments with precision."},
...
function ProductCard({
  ...
  if (product.cardVariant === "wide-compact") {
    ...
    if (isTransporte) {
      ...
      const transporteBannerStyle: React.CSSProperties = {
        background: "white",
        border: `1px solid ${BRAND.line}`,
        borderRadius: 22,
        overflow: "hidden",
